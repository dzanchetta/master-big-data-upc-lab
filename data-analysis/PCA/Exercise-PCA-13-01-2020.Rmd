...
psiactdim1 <- mean(pca.churn$ind$coord[,1])
psiactdim2 <- mean(pca.churn$ind$coord[,2])
psiactdim3 <- mean(pca.churn$ind$coord[,3])

lambda1 <- pca.churn$eig[1,1]
lambda2 <- pca.churn$eig[2,1]
lambda3 <- pca.churn$eig[3,1]

v.testdim1 <- (psisupdim1-psiactdim1)/sqrt((1-(nsup/n))*(lambda1/nsup))
v.testdim1
vtestdim2 <-  (psisupdim2-psiactdim2)/sqrt((1-(nsup/n))*(lambda2/nsup))
vtestdim2
vtestdim3 <-  (psisupdim3-psiactdim3)/sqrt((1-(nsup/n))*(lambda3/nsup))
vtestdim3
```
