---
title: "Exericio-04-12-2019-Regression"
...
```{r}
bcnpisos<-read.csv("C:/Users/Daniel/Documents/Certificados & Faculdade/UPC Master Big Data/Data Analytics/Aula 5 - 04-12/exer3/bcn_pisos.txt", header=TRUE,sep="\t")
View(bcnpisos)
...
regresion_valor_tot_step <- lm(formula = Valor ~ Superf + Dorm + Banys + Edat + Estat + Planta + Dist + ValSol + Tipus + ExtInt + Reforma, data = training_bcnpisos)
...
2) ¿Existe alguna relación de dependencia con los valores ajustados? -->  Resp.: 
